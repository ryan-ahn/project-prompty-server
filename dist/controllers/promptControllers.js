...
const createPromptController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield services_1.promptServices.createPromptService(postCreateDto);
        res
            .status(modules_1.statusCode.CREATED)
            .send(modules_1.util.success(modules_1.statusCode.CREATED, modules_1.responseMessage.CREATE_POST_SUCCESS, data));
    }
    catch (error) {
        console.log(error);
        res
...
const readPromptByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.send(modules_1.util.success(modules_1.statusCode.OK, modules_1.responseMessage.READ_POST_SUCCESS, data));
    }
    catch (error) {
        res
            .status(modules_1.statusCode.INTERNAL_SERVER_ERROR)
